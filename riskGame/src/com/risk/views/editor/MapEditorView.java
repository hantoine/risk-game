...
public class MapEditorView extends javax.swing.JFrame implements MapModelObserver {
    ...
    /**
     * Panel which contains the list of continents and allow to edit them and create new one.
     */
    protected ContinentListPanel continentsPanel;
    
    /**
     * Panel which contains the tools of the editor like adding country, editing country etc.
     */
    protected CustomListPanel toolsPanel;
    
    /**
     * Panel which allow to modify the configuration informations of the map like the author for example.
     */
     ...
     * @param width
     * @param height
     * @param editorController Controller of the editor using to retrieve listeners.
     * @param initMapModel Model of the map which is being edited, used to intialize the map editor.
    ...
    /**
     * Create the items for the menu bar, attach their listeners and add them to the menu bar. 
     * @param menuFile Menu which will get the new items.
     * @param editorController Controller of the map editor which will be used for the listeners.
     */
    ...
    /**
     * Allow to select a file and then tells the editor controller to update the model from the file.
    ...
    /**
     * Allow to clear the map being editing.
     * It asks for the user's confirmation before clear.
    ...
    /**
     * Initialize the menu bar on top of the editor with save, load and clear options.
    ...
    /**
     * Button listener to change the current mode of the "map panel" when the user click on a tool to select it.
     * The map panel is the panel where the map is being edited. 
     * This method change the mode of the map panel when a tool is selected.
     * @see MapView
     */
     ...
     * @param updateType element of the UpdateTypes enums that will indicate which action to do. 
